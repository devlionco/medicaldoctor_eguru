...
$fburl    = trim($fburl);
$insturl  = theme_eguru_get_setting('insturl');
$insturl  = trim($insturl);
...
$socialurl = ($fburl != '' || $insturl != '' || $pinurl != '' || $twurl != '' || $gpurl != '') ? 1 : 0;
...
$inst = get_string('mediaicon5', 'theme_eguru');
...
$instn = get_string('medianame5', 'theme_eguru');
