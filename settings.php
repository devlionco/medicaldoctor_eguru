...
if (is_siteadmin()) {
    ...
    $name = 'theme_eguru/insturl';
    $title = get_string('insturl', 'theme_eguru');
    $description = get_string('insturldesc', 'theme_eguru');
    $default = get_string('insturl_default', 'theme_eguru');
    $setting = new admin_setting_configtext($name, $title, $description, $default);
    $temp->add($setting);
